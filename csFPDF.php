...
$header = array('Specialty', ' AVG Consumer Satisfaction', 'Time Worked', 'Support Cost');
// Data loading
	$result = array();
...
$pdf->Cell( 180, 20, $chartTitle, 0, 0, 'C' );
$chartColours = array(
                  array( 255, 100, 100 ),
                  array( 100, 255, 100 ),
                  array( 100, 100, 255 ),
...
$date = date('m/d/Y');
$fileName = 'Consumer_Call_Report_' .$_SESSION['oldstartdate']. '-' .$_SESSION['oldenddate']. '.pdf';
